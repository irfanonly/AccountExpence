...
namespace AccountPlus.BusinessLogic
{
    public class Users
    {
        ...
        public bool CreateNewUser(int roleId, string userName, string password, string firstName, string lastName, string email, string mobile, bool isActive)
        {
            ...
            paramCollection.Add(new DBParameter("@Last_Login_Date", DateTime.Now,DbType.DateTime));
            paramCollection.Add(new DBParameter("@Password_Change_Date", DateTime.Now,DbType.DateTime));
            ...
            Query = "INSERT INTO User_Info(RoleId, User_Name, Pwd, First_Name, Last_Name, " +
                ...
                "@Last_Login_Date" + ", @Password_Change_Date" + ", @email, @mobile, 1)";
